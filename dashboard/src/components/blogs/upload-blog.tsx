...
export function UploadBlog({
  ...
  // Uploading writes through the engine: the record commit plus the scratch copy agents read.
  // The hosted build has no engine behind it, so it offers no way to do this at all.
  if (HOSTED_READONLY) {
    return null;
  }
